<?php
    ...
    class TorneioSaoBernardo extends Model
    {
                ...
                case Stage::OITAVAS_DE_FINAL:
                    ...
                    for ( $i = 0; $i < 4; $i++ ) {
                        ...
                        $results = $sql->select( "SELECT TOP(4) team FROM tb_groupstages WHERE season = :SEASON AND competition = :COMPETITION AND nrgroup = :NRGROUP 
                            ...
                            ":COMPETITION" => TorneioSaoBernardo::ID,
                            ":NRGROUP" => $i + 1
                        ]);
        ...
        { 
            ...
            for ( $i = 0; $i < count( $teams ); $i++ ) {
                ...
                $add = " (" . Season::getCurrent() . ", " . TorneioSaoBernardo::ID . ", " . $nrgroup . ", " . $teams[$i] . "),";
        ...
        public function saveMatchdays( $nrgroup ) // Salva quais serão as rodadas do campeonato
        {
            ...
            for ($i = 0; $i < count( $matchdays ) ; $i++) { 
                ...
                for ($x = 0; $x < count( $matchdays[$i] ) ; $x++) { 
                    ...
                    if ( in_array( $round, TorneioSaoBernardo::MIDDLEWEEK_MATCHES ) ) {

                        $randkey = array_rand( TorneioSaoBernardo::MIDDLEWEEK_TIMES );

                        $matchtime = TorneioSaoBernardo::MIDDLEWEEK_TIMES[$randkey];

                    } else {

                        $randkey = array_rand( TorneioSaoBernardo::WEEKEND_TIMES );

                        $matchtime = TorneioSaoBernardo::WEEKEND_TIMES[$randkey];
        ...
        public function listStandings( $group ) // Traz a tabela de classificação
        {
            ...
            for ( $i = 0; $i < count( $standings ); $i++ ) { 
                ...
                $standings[$i]['lastResults'] = LeagueFunctions::getTeamLastResults( $standings[$i]['id'], TorneioSaoBernardo::ID, $group );
        ...
        public function save() // Salva os resultados das partidas
        {
            ...
            for ( $i = 0; $i < count( $matches ); $i++ ) {
                ...
                // Time 1
                $teamGroup = TorneioSaoBernardo::getTeamGroup( $matches[$i]['team1'] );

                LeagueFunctions::updateStanding( $matches[$i]['team1'], TorneioSaoBernardo::ID, $teamGroup, $teamGroup );


                // Time 2
                $teamGroup = TorneioSaoBernardo::getTeamGroup( $matches[$i]['team2'] );

                LeagueFunctions::updateStanding( $matches[$i]['team2'], TorneioSaoBernardo::ID, $teamGroup, $teamGroup );
        ...
        public function savePlayoffMatches( $stage ) 
        {
            ...
            for ($i = 0; $i < count( $matches ) ; $i++) { 
                ...
                $add = '(' . Season::getCurrent() . ',' . TorneioSaoBernardo::ID . ',' . $stage . ',' . 1 . ',' . $matches[$i][0] . ',' . $matches[$i][1] . ',' . "'DOM - 16:00'" . '),';
        ...
        {
            if ( PlayoffFunctions::checkExists( TorneioSaoBernardo::ID, Stage::OITAVAS_DE_FINAL ) === false) {
                ...
                if ( count( $results ) === 0 ) {
                    ...
                    TorneioSaoBernardo::createPlayoff( Stage::OITAVAS_DE_FINAL );
                }
        ...
        {
            if ( PlayoffFunctions::checkExists( TorneioSaoBernardo::ID, Stage::QUARTAS_DE_FINAL ) === false) {
                ...
                if ( count( $results ) === 0 ) {
                    ...
                    TorneioSaoBernardo::createPlayoff( Stage::QUARTAS_DE_FINAL );
                }
        ...
        {
            if ( PlayoffFunctions::checkExists( TorneioSaoBernardo::ID, Stage::SEMI_FINAL ) === false) {
                ...
                if ( count( $results ) === 0 ) {
                    ...
                    TorneioSaoBernardo::createPlayoff( Stage::SEMI_FINAL );
                }
        ...
        {
            if ( PlayoffFunctions::checkExists( TorneioSaoBernardo::ID, Stage::_FINAL ) === false) {
                ...
                if ( count( $results ) === 0 ) {
                    ...
                    TorneioSaoBernardo::createPlayoff( Stage::_FINAL );
                }
        ...
        public function load() // Carrega as informações e redeniza a tela
        {
            ...
            $page->render('stage', [
                ...
                'matches' => [
                    ...
                    'saveURL' => '/torneio-sao-bernardo/playoffs/' . Stage::OITAVAS_DE_FINAL,
                ]
            ]);
            ...
            $page->render('stage', [
                ...
                'matches' => [
                    ...
                    'saveURL' => '/torneio-sao-bernardo/playoffs/' . Stage::QUARTAS_DE_FINAL,
                ]
            ]);
            ...
            $page->render('stage', [
                ...
                'matches' => [
                    ...
                    'saveURL' => '/torneio-sao-bernardo/playoffs/' . Stage::SEMI_FINAL,
                ]
            ]);
            ...
            $page->render('stage', [
                ...
                'matches' => [
                    ...
                    'saveURL' => '/torneio-sao-bernardo/playoffs/' . Stage::_FINAL,
                ]
            ]);
        }
