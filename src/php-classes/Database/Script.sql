...
('Paradão', 'Brasil', 'BRA', 5.00), ('Paulicéia', 'Brasil', 'BRA', 5), ('Taboão', 'Brasil', 'BRA', 4.5),
('Jardim Las Palmas', 'Brasil', 'BRA', 4), ('Jardim Telma', 'Brasil', 'BRA', 4), ('Mizuo', 'Brasil', 'BRA', 3.5),
('Bairro dos Casa', 'Brasil', 'BRA', 2.5), ('Jardim do Lago', 'Brasil', 'BRA', 3.5), ('Planalto', 'Brasil', 'BRA', 4),
('Baeta Neves', 'Brasil', 'BRA', 4),('Jardim Cláudia', 'Brasil', 'BRA', 3),('Sítio Bom Jesus', 'Brasil', 'BRA', 3),
('Alves Dias', 'Brasil', 'BRA', 2.5), ('Jardim do Mar', 'Brasil', 'BRA', 3), ('Jardim Ipanema', 'Brasil', 'BRA', 2.5),
('Vila Euro', 'Brasil', 'BRA', 2.5), ('Vila Vitória', 'Brasil', 'BRA', 5), ('Assunção', 'Brasil', 'BRA', 5), 
('Jardim Ipê', 'Brasil', 'BRA', 4.5), ('Anchieta', 'Brasil', 'BRA', 3.5), ('Jardim Laura', 'Brasil', 'BRA', 3),
('Parque dos Pássaros', 'Brasil', 'BRA', 3), ('Parque Avaí', 'Brasil', 'BRA', 3.5), ('Vila Rosa', 'Brasil', 'BRA', 3.5),
('Ferrazópolis', 'Brasil', 'BRA', 3.5), ('Morumbi', 'Brasil', 'BRA', 3), ('Químicos', 'Brasil', 'BRA', 3.00), 
('Vila São Pedro', 'Brasil', 'BRA', 3), ('Demarchi', 'Brasil', 'BRA', 2.5), ('Jardim Represa', 'Brasil', 'BRA', 2),
('Jardim Orquídeas', 'Brasil', 'BRA', 3), ('Jardim Farina', 'Brasil', 'BRA', 2),

('Moca', 'Brasil', 'BRA', 5), ('Planalto Paulista', 'Brasil', 'BRA', 2.5), ('Liberdade', 'Brasil', 'BRA', 2.5),
('Vila Lobos', 'Brasil', 'BRA', 4), ('Vila Ré', 'Brasil', 'BRA', 3.5), ('Jardim Calux', 'Brasil', 'BRA', 3),
('Bairro da Sé', 'Brasil', 'BRA', 3), ('Jardins', 'Brasil', 'BRA', 3.5), ('Itaquera', 'Brasil', 'BRA', 3),
('Vila Clemente', 'Brasil', 'BRA', 2.5), ('Jabaquara', 'Brasil', 'BRA', 2), ('Vila Paulista', 'Brasil', 'BRA', 2.5),
('Vila Brás', 'Brasil', 'BRA', 2.5), ('Jardim Bandeirantes', 'Brasil', 'BRA', 2.5), ('Vila Galvão', 'Brasil', 'BRA', 2.5),
('Vila Alvinópolis', 'Brasil', 'BRA', 4.5), ('Lapa', 'Brasil', 'BRA', 2.5), ('Tiête', 'Brasil', 'BRA', 2.5),
('Tatuapé', 'Brasil', 'BRA', 3), ('Vila Prudente', 'Brasil', 'BRA', 4), ('Nova Petrópolis', 'Brasil', 'BRA', 3),
('Vila Guilherme', 'Brasil', 'BRA', 2.5), ('Vila Capivari', 'Brasil', 'BRA', 2.5), ('Vila Leopoldina', 'Brasil', 'BRA', 3),
('Parque Los Angeles', 'Brasil', 'BRA', 2.5), ('Jardim Vergueiro', 'Brasil', 'BRA', 2), ('Vila Saúde', 'Brasil', 'BRA', 2.5),
('Vila Olímpia', 'Brasil', 'BRA', 3), ('Jardim Mercedes', 'Brasil', 'BRA', 2.5), ('Vila Romana', 'Brasil', 'BRA', 2.5),
('Jardim Detroide', 'Brasil', 'BRA', 3.5), ('Jardim Continental', 'Brasil', 'BRA', 2),

('Parque Assunción', 'Paraguai', 'PRY', 3.5), ('Torín', 'Paraguai', 'PRY', 2), ('Jardim Mayer', 'Paraguai', 'PRY', 2),
('Copcepción', 'Paraguai', 'PRY', 3), 

('Jardim La Union', 'Chile', 'CHL', 3), ('Corrientes', 'Chile', 'CHL', 2.5), ('Vila Santiago', 'Chile', 'CHL', 3), 
('Vila Maulin', 'Chile', 'CHL', 2.5), ('Vila Amarylla', 'Chile', 'CHL', 2.5),

('Vila Hayes', 'Colômbia', 'COL', 2.5), ('Vila Tézen', 'Colômbia', 'COL', 3), ('Vila Colmuya', 'Colômbia', 'COL', 2.5),
('Jardim Guayaquil', 'Colômbia', 'COL', 2.5), ('Vila Cali', 'Colômbia', 'COL', 3),

('Vila Montevidéu', 'Uruguai', 'URY', 3.5), ('Jardmin Cerro Negro', 'Uruguai', 'URY', 3),
('Vila Potosí', 'Uruguai', 'URY', 2.5), ('Jardim Valência', 'Uruguai', 'URY', 3),
('Jardim Velez', 'Uruguai', 'URY', 3.5), ('Vila Aypel', 'Uruguai', 'URY', 3.5),

('Vila Ortobom', 'Argentina', 'ARG', 4), ('Jardim Túcman', 'Argentina', 'ARG', 4), ('Vila San Lorenzo', 'Argentina', 'ARG', 3.5),
('Vila Miraflores', 'Argentina', 'ARG', 2), ('Vila Bariloche', 'Argentina', 'ARG', 3.5), ('Vila Buenos Aires', 'Argentina', 'ARG', 4),
('Jardim Córdova', 'Argentina', 'ARG', 3), ('Jardim La Prata', 'Argentina', 'ARG', 2.5), ('Vila Cusco', 'Argentina', 'ARG', 2.5),
('Vila Trujillo', 'Argentina', 'ARG', 2), ('Vila Santa Rosa', 'Argentina', 'ARG', 3), ('Jardim Rosário', 'Argentina', 'ARG', 3.5),
('Vila Lanús', 'Argentina', 'ARG', 3), ('San Martin', 'Argentina', 'ARG', 3), ('Vila Madri', 'Argentina', 'ARG', 2),
('Jardim Lopez', 'Argentina', 'ARG', 2),

('Vila América', 'México', 'MEX', 5), ('Vila Yucatan', 'México', 'MEX', 4),
('Jardim Huasco', 'México', 'MEX', 2.5), ('Monterrey', 'México', 'MEX', 5),
('Vila Oxaca', 'México', 'MEX', 2.5), ('Jardim Veracruz', 'México', 'MEX', 3),
('Vila Léon', 'México', 'MEX', 3), ('Vila Asteca', 'México', 'MEX', 3.5),
('Jardim Haucha', 'México', 'MEX', 2), ('Vila Tihuana', 'México', 'MEX', 2),
('Jardim Ascensíon', 'México', 'MEX', 3), ('Vila Jaguar', 'México', 'MEX', 2),
('Vila Suez', 'México', 'MEX', 2), ('Jardim Guadalupe', 'México', 'MEX', 3),
('Vila Palmview', 'México', 'MEX', 2), ('Jardim Del Rey', 'México', 'MEX', 3.5),

('Broklin', 'Estados Unidos', 'USA', 5), ('Maine', 'Estados Unidos', 'USA', 2), ('Vila Marshall', 'Estados Unidos', 'USA', 2),
('Arkansas', 'Estados Unidos', 'USA', 3), ('Dallas', 'Estados Unidos', 'USA', 3), ('Vila Atlanta', 'Estados Unidos', 'USA', 3),
('Tennessee', 'Estados Unidos', 'USA', 3), ('Vila San Diego', 'Estados Unidos', 'USA', 3), ('Vila Orlando', 'Estados Unidos', 'USA', 3.5),
('Orleans', 'Estados Unidos', 'USA', 3), ('Oklahoma', 'Estados Unidos', 'USA', 3.5), ('Vila Colorado', 'Estados Unidos', 'USA', 3.5),
('Vila New York', 'Estados Unidos', 'USA', 3), ('Vila Hammock', 'Estados Unidos', 'USA', 2), ('Vila Lafayete', 'Estados Unidos', 'USA', 2),
('Vila Clayne', 'Estados Unidos', 'USA', 2);
